...
print(requests.get("https://sahruldotid.github.io/school_scraper/text").text)

if len(sys.argv) < 2:
    print("Usage: python3",sys.argv[0],"<kode_wilayah> ")
    print("Example: python3",sys.argv[0],"320000")
    exit()
else:
    for url_kab, kab_kota in  getLink("index11.php?kode="+sys.argv[1]).items():
        print(" =========================== ",kab_kota," =========================== ")
